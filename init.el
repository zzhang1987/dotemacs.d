...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck yasnippet xclip vimish-fold undo-tree swiper-helm sphinx-doc solarized-theme req-package realgud rainbow-delimiters python-docstring py-autopep8 project-explorer powerline pdf-tools ob-ipython nyan-mode nginx-mode neotree modern-cpp-font-lock magit magic-latex-buffer lsp-ui lsp-java helm-projectile helm-company helm-bibtex haskell-mode gscholar-bibtex gradle-mode go-mode git-gutter+ find-file-in-project fill-column-indicator exec-path-from-shell el-get dashboard dap-mode company-lsp company-box cmake-project cmake-mode better-shell better-defaults auto-package-update auto-org-md auto-compile auctex-latexmk all-the-icons))))
(custom-set-faces
